# Generated by Django 2.2.14 on 2021-04-15 10:17
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('partner', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, to='management_app.Partner')),
                ('user', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='task_assigned', to=settings.AUTH_USER_MODEL, verbose_name='assigned to')),
            ],
            options={
                'verbose_name': 'Task',
